...
Once you get the rtl_433 sensor data into MQTT, you'll need to help Home Assistant discover and make sense of it. You can do that in a number of ways:
  ...
  * install the [rtl_433 MQTT Auto Discovery Home Assistant Add-on](https://github.com/bartrumb/rtl_433-hass-addons/tree/main/rtl_433_mqtt_autodiscovery), which runs rtl_433_mqtt_hass.py for you.
